        ...
        <div class="bg-slate-50 dark:bg-slate-800/80 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/60 shadow-xs">
          ...
          <div id="profile-source-container" class="w-full">
            ...
            <div id="profile-qr-box" class="hidden flex flex-col gap-2.5">
              ...
              <button id="profile-stop-scan-btn" type="button" class="w-full py-2.5 px-3 text-xs font-bold text-white bg-red-600 hover:bg-red-700 active:bg-red-800 rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-sm cursor-pointer">
